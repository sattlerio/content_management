        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <h2 class="title text-danger">500 - Server Error</h2>
              <h2 class="title">Sorry! It seems there was a internal problem. <br>
              If the problem persists please contact our support team.</h2>
            </div>
          </div>
        </div>
      </div>
